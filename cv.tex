...
%\usepackage{fontspec}
% \newcommand*{\googlescholar}{\includegraphics[width=1.5ex, natwidth=610,natheight=642]{google-scholar.pdf}} % if using latex
\newcommand*{\googlescholar}{\includegraphics[width=1.5ex]{google-scholar.pdf}} % lualatex
...
\newcommand*{\webpage}{(see my \href{https://modifiedbear.github.io}{website})}
